...
print()
print("   For comparison, gate S1 on the Bayes filter, unchanged since handoff:")
print("      ECE=0.091, monotone=False, predicted 0.998 -> actual 0.919 at the")
print("      top decile and predicted 0.011 -> actual 0.500 at the bottom.")
print("   S1 has been RED since the handoff. It says the filter's probabilities")
print("   are wrong. This ablation is the first thing built that exploits that.")
